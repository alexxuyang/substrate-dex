...
mod token {
    ...
    #[automatically_derived]
    #[allow(unused_qualifications)]
    impl<Hash: ::core::clone::Clone, Balance: ::core::clone::Clone> ::core::clone::Clone
        for Token<Hash, Balance>
    {
        #[inline]
        fn clone(&self) -> Token<Hash, Balance> {
            match *self {
                Token {
                    hash: ref __self_0_0,
    ...
    #[automatically_derived]
    #[allow(unused_qualifications)]
    impl<Hash: ::core::cmp::PartialEq, Balance: ::core::cmp::PartialEq> ::core::cmp::PartialEq
        for Token<Hash, Balance>
    {
        #[inline]
        fn eq(&self, other: &Token<Hash, Balance>) -> bool {
            match *other {
                Token {
                    hash: ref __self_1_0,
        ...
        #[inline]
        fn ne(&self, other: &Token<Hash, Balance>) -> bool {
            match *other {
                Token {
                    hash: ref __self_1_0,
                    symbol: ref __self_1_1,
    ...
    #[automatically_derived]
    #[allow(unused_qualifications)]
    impl<Hash: ::core::fmt::Debug, Balance: ::core::fmt::Debug> ::core::fmt::Debug
        for Token<Hash, Balance>
    {
        fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
            match *self {
                Token {
                    ...
                    let _ = debug_trait_builder.field("symbol", &&(*__self_0_1));
                    let _ = debug_trait_builder.field("total_supply", &&(*__self_0_2));
                    debug_trait_builder.finish()
                }
            }
        }
        ...
        > ::core::clone::Clone for RawEvent<AccountId, Hash, Balance>
    {
        ...
        fn clone(&self) -> RawEvent<AccountId, Hash, Balance> {
            match (&*self,) {
                (&RawEvent::Issued(ref __self_0, ref __self_1, ref __self_2),) => RawEvent::Issued(
                    ::core::clone::Clone::clone(&(*__self_0)),
                    ::core::clone::Clone::clone(&(*__self_1)),
                    ::core::clone::Clone::clone(&(*__self_2)),
                ),
                (&RawEvent::Transferd(ref __self_0, ref __self_1, ref __self_2, ref __self_3),) => {
                    RawEvent::Transferd(
                        ::core::clone::Clone::clone(&(*__self_0)),
                        ::core::clone::Clone::clone(&(*__self_1)),
                        ::core::clone::Clone::clone(&(*__self_2)),
                ...
                if true && __self_vi == __arg_1_vi {
                    match (&*self, &*other) {
                        (
                            ...
                            &RawEvent::Issued(ref __arg_1_0, ref __arg_1_1, ref __arg_1_2),
                        ) => {
                            (*__self_0) == (*__arg_1_0)
                                && (*__self_1) == (*__arg_1_1)
                                && (*__self_2) == (*__arg_1_2)
            ...
            Balance: _parity_codec::Encode,
        {
            fn encode_to<EncOut: _parity_codec::Output>(&self, dest: &mut EncOut) {
                match *self {
                    ...
                    RawEvent::Transferd(ref aa, ref ba, ref ca, ref da) => {
    ...
    const _IMPL_DECODE_FOR_RawEvent: () = {
            ...
            Balance: _parity_codec::Decode,
        {
            fn decode<DecIn: _parity_codec::Input>(input: &mut DecIn) -> Option<Self> {
                match input.read_byte()? {
                    x if x == 0usize as u8 => Some(RawEvent::Issued(
                        _parity_codec::Decode::decode(input)?,
                        _parity_codec::Decode::decode(input)?,
                        _parity_codec::Decode::decode(input)?,
                    )),
                    x if x == 1usize as u8 => Some(RawEvent::Transferd(
                        _parity_codec::Decode::decode(input)?,
                        _parity_codec::Decode::decode(input)?,
                        _parity_codec::Decode::decode(input)?,
                        _parity_codec::Decode::decode(input)?,
        ...
        ::core::fmt::Debug for RawEvent<AccountId, Hash, Balance>
    {
        fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
            match (&*self,) {
                ...
                (&RawEvent::Transferd(ref __self_0, ref __self_1, ref __self_2, ref __self_3),) => {
                    let mut debug_trait_builder = f.debug_tuple("Transferd");
                    let _ = debug_trait_builder.field(&&(*__self_0));
                    let _ = debug_trait_builder.field(&&(*__self_1));
                    let _ = debug_trait_builder.field(&&(*__self_2));
    ...
    impl<AccountId, Hash, Balance> RawEvent<AccountId, Hash, Balance> {
        ...
        pub fn metadata() -> &'static [::srml_support::event::EventMetadata] {
            &[
                ::srml_support::event::EventMetadata {
                    name: ::srml_support::event::DecodeDifferent::Encode("Issued"),
                ...
                ::srml_support::event::EventMetadata {
                    name: ::srml_support::event::DecodeDifferent::Encode("Transferd"),
                    arguments: ::srml_support::event::DecodeDifferent::Encode(&[
                        "AccountId",
                        "AccountId",
                        "Hash",
    ...
    #[doc(hidden)]
    pub struct __GetByteStructOwnedTokensIndex<T>(
        pub  self::sr_api_hidden_includes_decl_storage::hidden_include::rstd::marker::PhantomData<
            (T),
        >,
    );
    #[cfg(feature = "std")]
    #[allow(non_upper_case_globals)]
    static __CACHE_GET_BYTE_STRUCT_OwnedTokensIndex:
        self::sr_api_hidden_includes_decl_storage::hidden_include::once_cell::sync::OnceCell<
            self::sr_api_hidden_includes_decl_storage::hidden_include::rstd::vec::Vec<u8>,
        > =
        self::sr_api_hidden_includes_decl_storage::hidden_include::once_cell::sync::OnceCell::INIT;
    #[cfg(feature = "std")]
    impl<T: Trait> self::sr_api_hidden_includes_decl_storage::hidden_include::metadata::DefaultByte
        for __GetByteStructOwnedTokensIndex<T>
    {
        fn default_byte(
            &self,
        ) -> self::sr_api_hidden_includes_decl_storage::hidden_include::rstd::vec::Vec<u8> {
            use self::sr_api_hidden_includes_decl_storage::hidden_include::codec::Encode;
            __CACHE_GET_BYTE_STRUCT_OwnedTokensIndex
                .get_or_init(|| {
    ...
    impl<T: Trait> Store for Module<T> {
        ...
        type OwnedTokensIndex = OwnedTokensIndex<T>;
        type Nonce = Nonce<T>;
    }
    impl<T: 'static + Trait> Module<T> {
        pub fn token<
    ...
    impl<T: Trait> Module<T> {
        ...
        pub fn freeze(origin: T::Origin, hash: T::Hash, amount: T::Balance) -> Result {
        ...
        pub fn unfreeze(origin: T::Origin, hash: T::Hash, amount: T::Balance) -> Result {
            let sender = ensure_signed(origin)?;
            {
                if !<FreeBalanceOf<T>>::exists((sender.clone(), hash.clone())) {
                    {
    ...
    pub enum Call<T: Trait> {
        ...
        #[allow(non_camel_case_types)]
        transfer(T::Hash, T::AccountId, T::Balance),
        #[allow(non_camel_case_types)]
    ...
    impl<T: Trait> ::srml_support::dispatch::Clone for Call<T> {
        fn clone(&self) -> Self {
            match *self {
                ...
                Call::transfer(ref token_hash, ref to, ref amount) => {
                    Call::transfer((*token_hash).clone(), (*to).clone(), (*amount).clone())
                }
                ...
                _ => ::std::rt::begin_panic(
                    "internal error: entered unreachable code",
                    &("runtime/src/token.rs", 48u32, 1u32),
                ),
            }
        }
    }
    impl<T: Trait> ::srml_support::dispatch::PartialEq for Call<T> {
        fn eq(&self, _other: &Self) -> bool {
            match *self {
                ...
                Call::transfer(ref token_hash, ref to, ref amount) => {
                    let self_params = (token_hash, to, amount);
                    if let Call::transfer(ref token_hash, ref to, ref amount) = *_other {
                        self_params == (token_hash, to, amount)
                    } else {
                        match *_other {
                            Call::__PhantomItem(_, _) => ::std::rt::begin_panic(
                                "internal error: entered unreachable code",
            ...
            match *self {
                ...
                Call::transfer(ref token_hash, ref to, ref amount) => {
                    _f.write_fmt(::core::fmt::Arguments::new_v1(
                        ...
                        &match (
                            &"transfer",
                            &(token_hash.clone(), to.clone(), amount.clone()),
                        ) {
                            (arg0, arg1) => [
                                ::core::fmt::ArgumentV1::new(arg0, ::core::fmt::Display::fmt),
                                ::core::fmt::ArgumentV1::new(arg1, ::core::fmt::Debug::fmt),
    ...
    impl<T: Trait> ::srml_support::dispatch::Decode for Call<T> {
        fn decode<Input: ::srml_support::dispatch::Input>(input: &mut Input) -> Option<Self> {
            let _input_id = input.read_byte()?;
            {
                ...
                {
                    if _input_id == (0 + 1) {
                        let token_hash = ::srml_support::dispatch::Decode::decode(input)?;
                        let to = ::srml_support::dispatch::Decode::decode(input)?;
                        let amount = ::srml_support::dispatch::Decode::decode(input)?;
                        return Some(Call::transfer(token_hash, to, amount));
                    }
                    {
                        if _input_id == (0 + 1 + 1) {
        ...
        fn encode_to<W: ::srml_support::dispatch::Output>(&self, _dest: &mut W) {
            {
                ...
                {
                    if let Call::transfer(ref token_hash, ref to, ref amount) = *self {
                        _dest.push_byte((0 + 1) as u8);
                        token_hash.encode_to(_dest);
                        to.encode_to(_dest);
    ...
    impl<T: Trait> ::srml_support::dispatch::Dispatchable for Call<T> {
        ...
        fn dispatch(self, _origin: Self::Origin) -> ::srml_support::dispatch::Result {
            match self {
                ...
                Call::transfer(token_hash, to, amount) => {
                    <Module<T>>::transfer(_origin, token_hash, to, amount)
                }
        ...
        pub fn call_functions() -> &'static [::srml_support::dispatch::FunctionMetadata] {
            &[
                ...
                ::srml_support::dispatch::FunctionMetadata {
                    ...
                    arguments: ::srml_support::dispatch::DecodeDifferent::Encode(&[
                        ::srml_support::dispatch::FunctionArgumentMetadata {
                            name: ::srml_support::dispatch::DecodeDifferent::Encode("token_hash"),
...
mod trade {
    ...
    use runtime_primitives::traits::{Bounded, Member, SimpleArithmetic, Zero};
    use support::{
        ...
        fn eq(&self, other: &LimitOrder<T>) -> bool {
            match *other {
                LimitOrder {
                    ...
                    remained_amount: ref __self_1_6,
                    otype: ref __self_1_7,
                    status: ref __self_1_8,
                } => match *self {
                    LimitOrder {
                        hash: ref __self_0_0,
                        base: ref __self_0_1,
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
            match *self {
                LimitOrder {
                    ...
                    let _ = debug_trait_builder.field("amount", &&(*__self_0_5));
                    let _ = debug_trait_builder.field("remained_amount", &&(*__self_0_6));
                    let _ = debug_trait_builder.field("otype", &&(*__self_0_7));
                    let _ = debug_trait_builder.field("status", &&(*__self_0_8));
                    debug_trait_builder.finish()
                }
            }
        }
    }
    pub trait LimitOrderT<T>
    where
        T: Trait,
    {
        fn is_filled(&self) -> bool;
    }
    impl<T> LimitOrderT<T> for LimitOrder<T>
    where
        T: Trait,
    {
        fn is_filled(&self) -> bool {
    ...
    impl < T : Trait > self :: sr_api_hidden_includes_decl_storage :: hidden_include :: storage :: hashed :: generator :: StorageMap < ( T :: Hash , T :: Hash ) , T :: Hash > for TradePairsHashByBasequote < T > { type Query = Option < T :: Hash > ; type Hasher = self :: sr_api_hidden_includes_decl_storage :: hidden_include :: Blake2_256 ; # [ doc = r" Get the prefix key in storage." ] fn prefix ( ) -> & 'static [ u8 ] { "trade TradePairsHashByBasequote" . as_bytes ( ) } # [ doc = r" Get the storage key used to fetch a value corresponding to a specific key." ] fn key_for ( x : & ( T :: Hash , T :: Hash ) ) -> self :: sr_api_hidden_includes_decl_storage :: hidden_include :: rstd :: vec :: Vec < u8 > { let mut key = < Self as self :: sr_api_hidden_includes_decl_storage :: hidden_include :: storage :: hashed :: generator :: StorageMap < ( T :: Hash , T :: Hash ) , T :: Hash > > :: prefix ( ) . to_vec ( ) ; self :: sr_api_hidden_includes_decl_storage :: hidden_include :: codec :: Encode :: encode_to ( x , & mut key ) ; key } # [ doc = r" Load the value associated with the given key from the map." ] fn get < S : self :: sr_api_hidden_includes_decl_storage :: hidden_include :: HashedStorage < self :: sr_api_hidden_includes_decl_storage :: hidden_include :: Blake2_256 > > ( key : & ( T :: Hash , T :: Hash ) , storage : & S ) -> Self :: Query { let key = < Self as self :: sr_api_hidden_includes_decl_storage :: hidden_include :: storage :: hashed :: generator :: StorageMap < ( T :: Hash , T :: Hash ) , T :: Hash > > :: key_for ( key ) ; storage . get ( & key [ .. ] ) . or_else ( | | Default :: default ( ) ) } # [ doc = r" Take the value, reading and removing it." ] fn take < S : self :: sr_api_hidden_includes_decl_storage :: hidden_include :: HashedStorage < self :: sr_api_hidden_includes_decl_storage :: hidden_include :: Blake2_256 > > ( key : & ( T :: Hash , T :: Hash ) , storage : & S ) -> Self :: Query { let key = < Self as self :: sr_api_hidden_includes_decl_storage :: hidden_include :: storage :: hashed :: generator :: StorageMap < ( T :: Hash , T :: Hash ) , T :: Hash > > :: key_for ( key ) ; storage . take ( & key [ .. ] ) . or_else ( | | Default :: default ( ) ) } # [ doc = r" Mutate the value under a key" ] fn mutate < R , F : FnOnce ( & mut Self :: Query ) -> R , S : self :: sr_api_hidden_includes_decl_storage :: hidden_include :: HashedStorage < self :: sr_api_hidden_includes_decl_storage :: hidden_include :: Blake2_256 > > ( key : & ( T :: Hash , T :: Hash ) , f : F , storage : & S ) -> R { let mut val = < Self as self :: sr_api_hidden_includes_decl_storage :: hidden_include :: storage :: hashed :: generator :: StorageMap < ( T :: Hash , T :: Hash ) , T :: Hash > > :: get ( key , storage ) ; let ret = f ( & mut val ) ; match val { Some ( ref val ) => < Self as self :: sr_api_hidden_includes_decl_storage :: hidden_include :: storage :: hashed :: generator :: StorageMap < ( T :: Hash , T :: Hash ) , T :: Hash > > :: insert ( key , & val , storage ) , None => < Self as self :: sr_api_hidden_includes_decl_storage :: hidden_include :: storage :: hashed :: generator :: StorageMap < ( T :: Hash , T :: Hash ) , T :: Hash > > :: remove ( key , storage ) , } ; ret } }
    ...
    #[doc(hidden)]
    pub struct __GetByteStructSellOrders<T>(
        pub  self::sr_api_hidden_includes_decl_storage::hidden_include::rstd::marker::PhantomData<
            (T),
        >,
    );
    #[cfg(feature = "std")]
    #[allow(non_upper_case_globals)]
    static __CACHE_GET_BYTE_STRUCT_SellOrders:
        self::sr_api_hidden_includes_decl_storage::hidden_include::once_cell::sync::OnceCell<
            self::sr_api_hidden_includes_decl_storage::hidden_include::rstd::vec::Vec<u8>,
        > =
        self::sr_api_hidden_includes_decl_storage::hidden_include::once_cell::sync::OnceCell::INIT;
    #[cfg(feature = "std")]
    impl<T: Trait> self::sr_api_hidden_includes_decl_storage::hidden_include::metadata::DefaultByte
        for __GetByteStructSellOrders<T>
    {
        fn default_byte(
            &self,
        ) -> self::sr_api_hidden_includes_decl_storage::hidden_include::rstd::vec::Vec<u8> {
            use self::sr_api_hidden_includes_decl_storage::hidden_include::codec::Encode;
            __CACHE_GET_BYTE_STRUCT_SellOrders
                .get_or_init(|| {
    ...
    impl<T: 'static + Trait> Module<T> {
        ...
        >(
            ...
            < TradePairsHashByBasequote < T > as self :: sr_api_hidden_includes_decl_storage :: hidden_include :: storage :: hashed :: generator :: StorageMap < ( T :: Hash , T :: Hash ) , T :: Hash > > :: get ( key . borrow ( ) , & self :: sr_api_hidden_includes_decl_storage :: hidden_include :: storage :: RuntimeStorage )
        }
        pub fn order<
            K: self::sr_api_hidden_includes_decl_storage::hidden_include::rstd::borrow::Borrow<
                T::Hash,
                ...
                Some(mut item) => {
                    {
                        if !(item.orders.len() > 0) {
                            {
                                return Err("there is no order when we want to remove it");
                            };
                        }
                    };
                    let order_hash = item.orders.get(0);
                    {
                        if !order_hash.is_some() {
                            {
                                return Err(
                                    "can not get order from index 0 when we want to remove it",
                                );
                            };
                        }
                    };
                    ...
                    let order = order.unwrap();
                    {
                        if !order.is_filled() {
                            {
                                return Err("try to remove not filled order");
                            };
                        }
                    };
    ...
    impl<T: Trait> Module<T> {
        ...
        pub fn create_limit_order(
            ...
            let tp = Self::ensure_trade_pair(base, quote)?;
            {
                if !(price > Zero::zero()) {
                    {
                        return Err("price should be great than zero");
                    };
                }
            };
            let op_token_hash;
    ...
    impl<T: Trait> ::srml_support::dispatch::Clone for Call<T> {
        fn clone(&self) -> Self {
            match *self {
                ...
                _ => ::std::rt::begin_panic(
                    "internal error: entered unreachable code",
                    &("runtime/src/trade.rs", 261u32, 1u32),
                ),
            }
        }
    }
    ...
    impl<T: Trait> Module<T> {
        fn get_trade_pair_by_base_quote(
            base: T::Hash,
            quote: T::Hash,
        ) -> Option<TradePair<T::Hash>> {
        ...
        fn ensure_trade_pair(
            base: T::Hash,
            quote: T::Hash,
        ) -> result::Result<TradePair<T::Hash>, &'static str> {
            ...
            match bq {
                Some(bq) => return Ok(bq),
                None => return Err("not trade pair with base & quote"),
            }
        }
        fn do_create_trade_pair(origin: T::Origin, base: T::Hash, quote: T::Hash) -> Result {
            let sender = ensure_signed(origin)?;
            {
                if !(base != quote) {
                    {
                        return Err("base and quote can not be the same token");
                    };
                }
            };
            ...
            let quote_owner = <token::Module<T>>::owner(quote);
            {
                if !(base_owner.is_some() && quote_owner.is_some()) {
                    {
                        return Err("can't find owner of base or quote token");
                    };
                }
            };
            ...
            let quote_owner = quote_owner.unwrap();
            {
                if !(sender == base_owner || sender == quote_owner) {
                    {
                        return Err("sender should be equal to owner of base or quote token");
                    };
                }
            };
            let bq = Self::get_trade_pair_by_base_quote(base, quote);
            let qb = Self::get_trade_pair_by_base_quote(quote, base);
            {
                if !(!bq.is_some() && !qb.is_some()) {
                    {
                        return Err("the same trade pair already exists");
                    };
                }
            };
            let nonce = <Nonce<T>>::get();
    ...
    fn authorities() -> Vec<AuthorityId> {
        {
            ::std::rt::begin_panic(
                ...
                &("runtime/src/lib.rs", 258u32, 4u32),
            )
        }
    }
}
    ...
    pub fn dispatch(method: &str, mut data: &[u8]) -> Option<Vec<u8>> {
        match method {
            ...
            "Core_initialize_block" => {
                Some({
                    let header : < Block as BlockT > :: Header = match self :: sr_api_hidden_includes_IMPL_RUNTIME_APIS :: sr_api_client :: runtime_api :: Decode :: decode ( & mut data ) { Some ( input ) => input , None => { :: std :: rt :: begin_panic_fmt ( & :: core :: fmt :: Arguments :: new_v1 ( & [ "Bad input data provided to " ] , & match ( & "initialize_block" , ) { ( arg0 , ) => [ :: core :: fmt :: ArgumentV1 :: new ( arg0 , :: core :: fmt :: Display :: fmt ) ] , } ) , & ( "runtime/src/lib.rs" , 243u32 , 1u32 ) ) } } ;
            ...
            "BlockBuilder_inherent_extrinsics" => {
                Some({
                    let data : InherentData = match self :: sr_api_hidden_includes_IMPL_RUNTIME_APIS :: sr_api_client :: runtime_api :: Decode :: decode ( & mut data ) { Some ( input ) => input , None => { :: std :: rt :: begin_panic_fmt ( & :: core :: fmt :: Arguments :: new_v1 ( & [ "Bad input data provided to " ] , & match ( & "inherent_extrinsics" , ) { ( arg0 , ) => [ :: core :: fmt :: ArgumentV1 :: new ( arg0 , :: core :: fmt :: Display :: fmt ) ] , } ) , & ( "runtime/src/lib.rs" , 243u32 , 1u32 ) ) } } ;
            ...
            "BlockBuilder_check_inherents" => {
                Some({
                    let block : Block = match self :: sr_api_hidden_includes_IMPL_RUNTIME_APIS :: sr_api_client :: runtime_api :: Decode :: decode ( & mut data ) { Some ( input ) => input , None => { :: std :: rt :: begin_panic_fmt ( & :: core :: fmt :: Arguments :: new_v1 ( & [ "Bad input data provided to " ] , & match ( & "check_inherents" , ) { ( arg0 , ) => [ :: core :: fmt :: ArgumentV1 :: new ( arg0 , :: core :: fmt :: Display :: fmt ) ] , } ) , & ( "runtime/src/lib.rs" , 243u32 , 1u32 ) ) } } ;
                    let data : InherentData = match self :: sr_api_hidden_includes_IMPL_RUNTIME_APIS :: sr_api_client :: runtime_api :: Decode :: decode ( & mut data ) { Some ( input ) => input , None => { :: std :: rt :: begin_panic_fmt ( & :: core :: fmt :: Arguments :: new_v1 ( & [ "Bad input data provided to " ] , & match ( & "check_inherents" , ) { ( arg0 , ) => [ :: core :: fmt :: ArgumentV1 :: new ( arg0 , :: core :: fmt :: Display :: fmt ) ] , } ) , & ( "runtime/src/lib.rs" , 243u32 , 1u32 ) ) } } ;
            ...
            "TaggedTransactionQueue_validate_transaction" => Some({
                let tx : < Block as BlockT > :: Extrinsic = match self :: sr_api_hidden_includes_IMPL_RUNTIME_APIS :: sr_api_client :: runtime_api :: Decode :: decode ( & mut data ) { Some ( input ) => input , None => { :: std :: rt :: begin_panic_fmt ( & :: core :: fmt :: Arguments :: new_v1 ( & [ "Bad input data provided to " ] , & match ( & "validate_transaction" , ) { ( arg0 , ) => [ :: core :: fmt :: ArgumentV1 :: new ( arg0 , :: core :: fmt :: Display :: fmt ) ] , } ) , & ( "runtime/src/lib.rs" , 243u32 , 1u32 ) ) } } ;
            ...
            "OffchainWorkerApi_offchain_worker" => Some({
                let n : NumberFor < Block > = match self :: sr_api_hidden_includes_IMPL_RUNTIME_APIS :: sr_api_client :: runtime_api :: Decode :: decode ( & mut data ) { Some ( input ) => input , None => { :: std :: rt :: begin_panic_fmt ( & :: core :: fmt :: Arguments :: new_v1 ( & [ "Bad input data provided to " ] , & match ( & "offchain_worker" , ) { ( arg0 , ) => [ :: core :: fmt :: ArgumentV1 :: new ( arg0 , :: core :: fmt :: Display :: fmt ) ] , } ) , & ( "runtime/src/lib.rs" , 243u32 , 1u32 ) ) } } ;
